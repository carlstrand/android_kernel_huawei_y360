...
CUSTOM_KERNEL_TOUCHPANEL=GT1143 MSG2138 ft6336
...
CUSTOM_MODEM=wingtech82_wet_82kk_hspa_wt_pa_sky77593_band125_std
...
CUSTOM_KERNEL_LCM=ili9806e_dsi_vdo

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=ili9806e_dsi_vdo
...
#CREATE_PROJECT_INFO=20140220235210
WT_HUAWEI_PROJ = yes
WT_CTA_SUPPORT = no
WT_PSCALI = yes 
WT_CMCC_SUPPORT = no
...
WT_INNER_VERSION = SW_S98360A1_V001_M11_HUAWEI_Y360T_T0
WT_HARDWARE_VERSION = VER.A
WT_HARDWARE_VERSION_INNER = M11
WT_CMCC_VERSION = Y360-U03V100R001CHSC01B001
WT_CTA_VERSION = Y360-U03V100R001CHSC01B001
WT_PRODUCTION_VERSION = Y360-U03V100R001CHSC01B001
WT_NETSWITCH_CODE = *#*#4636#*#*
WT_CTA_VERSION_CODE = *#*#20120916#*#*
WT_CMCC_VERSION_CODE = *#*#20120917#*#*
WT_PRODUCT_VERSION_CODE = *988665#
WT_FACTORYMODE_CODE = *#66*#
WT_HUAWEI_AUDIO_DOUBLE_CHANNELS = yes
WT_MMS_SEND_EMPTY_MESSAGE = yes
WT_PSCALI = yes
WT_HUAWEI_AUDIOPROFILES_DISABLE = yes
WT_DRV_VIBRATOR_CONTROL_BY_GPIO = no
WT_TOUCHPAL_MODULE = yes
WT_SDCARD_PLUGIN_OUT = yes
MTK_BUILD_VERNO = ALPS.KK1.MP1.V2.10
WT_PARENT_PROJECT_DIR = wingtech82_cwet_kk
WT_EMAIL_CONFIG_FROM_XML = yes
###add for huawei nff test##
WT_HWNFF_SUPPORT = no
WT_CTP_GESTURE_SUPPORT=yes
WT_COMMON_SECURITY_KEY = no
WT_CUSTOM_SIGNAL_LEVEL_SUPPORT = yes
MTK_ENGMODE_GYRO_SUPPORT = no
WT_USB_STORAGE_ADD_USB_DEBUG = yes
WT_OTA_SUPPORT = yes
BUILD_GMS = yes
WT_ANIMATION_ROLL = yes
WT_ANIMATION_ROLL_PERCENT_NUMBER = no
WT_OVERSEA_PHONE_NUMBER_COMPARE_SUPPORT = yes
WT_EU_EARPHONE_SECURITY = yes
WT_USER_NAME = root
WT_HOST_NAME = ubuntu

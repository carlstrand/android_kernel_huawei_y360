...
#define KEY_WAKE_GESTURE           KEY_GESTURE// customize gesture-key
...
#define CTP_ADD_HW_INFO         1   //for adding tp hardware info to syste
...
0x4A,0xE0,0x01,0x20,0x03,0x02,0x01,0x01,0x01,0x00,\
0x00,0x00,0x5A,0x46,0x0F,0x01,0x00,0x00,0x00,0x99,\
0x25,0x14,0xAA,0x10,0x01,0x00,0x08,0x00,0x0F,0x65,\
0x05,0x08,0x53,0x06,0xFF,0xFC,0x24,0x05,0x33,0x58,\
0xF4,0x24,0x8C,0x8A,0x7C,0x7F,0x05,0x00,0x08,0x3D,\
0x00,0xDF,0x07,0x38,0xA0,0x98,0x41,0x03,0x09,0x00,\
0x00,0x32,0x46,0x80,0x94,0x55,0x00,0x00,0x04,0x84,\
0x33,0x81,0x37,0x80,0x3B,0x7F,0x3F,0x80,0x43,0x81,\
0x00,0x00,0x00,0x07,0x0C,0x11,0x00,0x52,0x50,0x32,\
0x00,0x00,0x17,0x05,0x31,0x28,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x32,0x3C,\
0x1E,0x02,0xC8,0x87,0x87,0x87,0x87,0x87,0x87,0x87,\
0x9B,0x9E,0x80,0x80,0x80,0x80,0x80,0x80,0x8C,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x0F,0x0D,0x0B,0x09,0x07,0x05,0x03,0x01,0xFF,0xFF,\
0x0E,0x0C,0x0A,0x08,0x06,0x04,0x02,0x00,0xFF,0xFF,\
0x1E,0x20,0x22,0x24,0x16,0x18,0x1A,0x1C,0x10,0xFF,\
0x1D,0x1F,0x21,0x23,0x15,0x17,0x19,0x1B,0x14,0xFF,\
0x30,0x30,0x30,0x30,0x30,0x32,0x32,0x36,0x30,0x30,\
0x30,0x30,0x30,0x30,0x30,0x30,0x40,0x32,0x32,0x39,\
0x3B,0x2B,0x32,0x40,0x40,0x40,0x40,0x40,0x40,0x40,\
0x40,0x40,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x0C,0x19,0x14,0x23,0xFE,0x0C,0x13,0x1C,0x01,0x0F,\
0x01,0x18,0x20,0x42,0x38,0x06,0x73,0x77,0x01\
}
...
//Log define
    #define GTP_TAG "Goodix-TP-TAG"
#define GTP_INFO(fmt,arg...)            xlog_printk(ANDROID_LOG_INFO,GTP_TAG,"<<-CTP-INFO->> "fmt"\n",##arg)
#define GTP_ERROR(fmt,arg...)         xlog_printk(ANDROID_LOG_ERROR,GTP_TAG,"<<-CTP-ERROR->> "fmt"\n",##arg)
#define GTP_DEBUG(fmt,arg...)          do{\
                                         if(GTP_DEBUG_ON)\
                                         xlog_printk(ANDROID_LOG_DEBUG,GTP_TAG,"<<-CTP-DEBUG->> [%d]"fmt"\n",__LINE__, ##arg);\
                                       }while(0)
#define GTP_DEBUG_ARRAY(array, num)    do{\
                                         ...
                                         {\
                                            xlog_printk(ANDROID_LOG_DEBUG,GTP_TAG,"<<-CTP-DEBUG-ARRAY->>\n");\
                                            for (i = 0; i < (num); i++)\
                                            {\
                                                xlog_printk(ANDROID_LOG_DEBUG,GTP_TAG,"%02x   ", (a)[i]);\
                                                if ((i + 1 ) %10 == 0)\
                                                {\
                                                   xlog_printk(ANDROID_LOG_DEBUG,GTP_TAG,"\n");\
                                                }\
                                            }\
                                            xlog_printk(ANDROID_LOG_DEBUG,GTP_TAG,"\n");\
                                        }\
...
#define GTP_DEBUG_FUNC()               do{\
                                         ...
                                         xlog_printk(ANDROID_LOG_DEBUG,GTP_TAG,"<<-CTP-FUNC->> Func:%s@Line:%d\n",__func__,__LINE__);\
                                       }while(0)

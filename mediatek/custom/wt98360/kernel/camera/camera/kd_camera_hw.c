...
u32 pinSet[2][8] = {
    ...
    if (On) {
		...
		if (currSensorName && ((0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW,currSensorName)) || (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW_YIWEILI,currSensorName))))
		{
		...
		else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2355MIPI_RAW,currSensorName)))
		{
			PK_DBG("kdCISModulePowerOn get in---  SENSOR_DRVNAME_OV5670_MIPI_RAW \n");
			PK_DBG("[ON_general 2.8V]sensorIdx:%d \n",SensorIdx);
		...
		else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV2680MIPI_RAW,currSensorName)) || currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV2680MIPI_RAW_YIWEILI,currSensorName)))
		{
			PK_DBG("kdCISModulePowerOn get in---  SENSOR_DRVNAME_OV2680MIPI_RAW \n");
			PK_DBG("[ON_general 2.8V]sensorIdx:%d \n",SensorIdx);
		...
		{
			PK_DBG("kdCISModulePower--off get in---SENSOR_DRVNAME_HI551_MIPI_RAW \n");
		...
		{
			PK_DBG("kdCISModulePower--off get in---SENSOR_DRVNAME_OV2680MIPI_RAW \n");

...
#include "CFG_PS_File.h"// added for ps sensor nvram
#include "CFG_GS_File.h"// added for gsensor nvram
#include "CFG_GPS_File.h"
#include "CFG_PS_Default.h"// added for ps sensor nvram
    ...
    const TCFG_FILE g_akCFG_File_Custom[]=
    {
...
#else
       {
		...
		{ "/data/nvram/APCFG/APRDCL/HWMON_PS",  VER(AP_CFG_RDCL_HWMON_PS_LID),  CFG_FILE_HWMON_PS_REC_SIZE, 
			CFG_FILE_HWMON_PS_REC_TOTAL,  SIGNLE_DEFUALT_REC, 	(char *)&ps_custom_default, DataReset , NULL
		},
		{ "/data/nvram/APCFG/APRDCL/HWMON_ACC_WTCH",	VER(AP_CFG_RDCL_HWMON_ACC_WTCH_LID),	CFG_FILE_HWMON_ACC_WTCH_REC_SIZE,	
		CFG_FILE_HWMON_ACC_WTCH_REC_TOTAL,			DEFAULT_ZERO,						0, DataReset , NULL
		},
    };

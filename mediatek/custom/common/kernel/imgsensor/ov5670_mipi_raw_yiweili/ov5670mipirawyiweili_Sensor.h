...
typedef struct
{
	...
	#define OV5670MIPI_WRITE_ID 	(0x6C) //(0x20)
	#define OV5670MIPI_READ_ID	    (0x6D) //(0x21)

	#define OV5670MIPI_SENSOR_ID            OV5670_SENSOR_ID


	UINT32 OV5670MIPI_YIWEILI_Open(void);
	UINT32 OV5670MIPI_YIWEILI_GetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution);
	UINT32 OV5670MIPI_YIWEILI_GetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_INFO_STRUCT *pSensorInfo, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
	UINT32 OV5670MIPI_YIWEILI_Control(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
	UINT32 OV5670MIPI_YIWEILI_FeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId, UINT8 *pFeaturePara,UINT32 *pFeatureParaLen);
	UINT32 OV5670MIPI_YIWEILI_Close(void);

...
#define GC2355_TEST_PATTERN_CHECKSUM 0x6c20a3b8 //0xca3667da //0x5d8082f0 //0x75bef806
...
static void GC2355MIPI_Sensor_Init(void)
{
	...
	GC2355MIPI_write_cmos_sensor(0x1b,0x48); //49
	...
	GC2355MIPI_write_cmos_sensor(0x1f,0xc9); //rsgl_s_mode/vpix_s_mode
	...
	GC2355MIPI_write_cmos_sensor(0x2b,0x80); //sf_s_mode FPN
	...
	GC2355MIPI_write_cmos_sensor(0xe4,0x01);
	GC2355MIPI_write_cmos_sensor(0xe5,0xff);
	/////////////////////////////////////////////////////
	//////////////////////   MIPI   /////////////////////
	/////////////////////////////////////////////////////
...
{
    SENSORDB("[GC2355SetTestPatternMode] Test pattern enable:%d\n", bEnable);
    if(bEnable) 
    {
    ...
    {
        GC2355MIPI_write_cmos_sensor(0x8B,0x00);  

...
//20130426 add basic data
	...
	#define s5k4h5yx_video_frame_length 		1265
	#define s5k4h5yx_video_line_length 		 	3688
	#define s5k4h5yx_preview_frame_length 		1265
	#define s5k4h5yx_preview_line_length 		3688
	#define s5k4h5yx_capture_frame_length 		2530
	#define s5k4h5yx_capture_line_length 		3688

	//pclk frequency
	#define s5k4h5yx_preview_pclk_frequency		140
	#define s5k4h5yx_capture_pclk_frequency		140
	#define s5k4h5yx_video_pclk_frequency		140

	#define s5k4h5yx_mhz_to_hz					1000000

	#define S5K4H5YX_IMAGE_SENSOR_FULL_WIDTH					(3264)	
	#define S5K4H5YX_IMAGE_SENSOR_FULL_HEIGHT					(2448)

	/* SENSOR PV SIZE */
	#define S5K4H5YX_IMAGE_SENSOR_PV_WIDTH					(1632)
	#define S5K4H5YX_IMAGE_SENSOR_PV_HEIGHT					(1224)

	#define S5K4H5YX_IMAGE_SENSOR_VIDEO_WIDTH					(1632)//(1920)
	#define S5K4H5YX_IMAGE_SENSOR_VIDEO_HEIGHT				(1224)//(1080)
...
#define S5K4H5YXMIPI_WRITE_ID  (0x20)//(0x6c)	//(0x20)
#define S5K4H5YXMIPI_READ_ID	(0x21)//(0x6d) //(0x21)



// SENSOR CHIP VERSION

//#define S5K4H5YXMIPI_SENSOR_ID         0x485b   //S5K4H5YX_SENSOR_ID

...
#define OV2680_TEST_PATTERN_CHECKSUM 0x64d5ee2e //0x86da3e5a
...
static void OV2680MIPI_Sensor_Init(void)
{
	...
	*/
	...
	OV2680_write_cmos_sensor(0x3021, 0x23);
	...
	OV2680_write_cmos_sensor(0x3820, 0xc6);//c2
	OV2680_write_cmos_sensor(0x3821, 0x05);//01
...
static void OV2680MIPI_Sensor_preview(void)
{
	...
	OV2680_write_cmos_sensor(0x3820, 0xc0);//c0
	OV2680_write_cmos_sensor(0x3821, 0x00);//00
...
UINT32 OV2680Open(void)
{
    ...
    int i, iLen;
    const kal_uint16 sccb_writeid[] = {OV2680_SLAVE_WRITE_ID_1};
	SENSORDB("OV2680Open\n");
...
UINT32 OV2680MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)

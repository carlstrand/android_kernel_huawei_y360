...
static struct data_resolution mpu6050c_gyro_data_resolution[] = {
...
static int MPU6050C_SetAccDataRange(struct i2c_client *client, u8 range)
{
	...
	mpu6050c_gyro_obj_i2c_data->reso = &mpu6050c_gyro_data_resolution[0];
...
/*----------------------------------------------------------------------------*/
late_initcall(mpu6050c_gyro_init);

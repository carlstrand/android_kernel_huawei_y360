...
bool IsBatMeterInited = KAL_FALSE; 
...
static kal_int32 oam_init_gFG_voltage_bk =0 ;
static kal_int32 oam_init_vol_bat_bk =0;
static kal_int32 oam_init_gFG_capacity_by_v_bk =0;
static kal_int32 oam_init_vbat_capacity_bk = 0;
static kal_int32 dod_init_g_rtc_fg_soc_bk = 0;
static kal_int32 dod_init_gFG_capacity_by_v_bk =0;
...
{
    return sizeof(battery_profile_temperature) / sizeof(BATTERY_PROFILE_STRUC) / TOTAL_BATTERY_NUMBER;
}

int fgauge_get_saddles_r_table(void)
{
    return sizeof(r_profile_temperature) / sizeof(R_PROFILE_STRUC) / TOTAL_BATTERY_NUMBER;
}
...
{
	#ifdef WT_BQ2022A_BAT_ID_SUPPORT
	int bat_module_id =  bq2022a_read_bat_module_id();	//check the battery
	switch(bat_module_id)
	{
		case 1: 	// 1 : Sunwoda + Samsung
			return sizeof(battery1_profile_t2) / sizeof(BATTERY_PROFILE_STRUC);
			break;
		case 7: 	// 7 :  Feimaotui + Samsung(MI2A)
			return sizeof(battery7_profile_t2) / sizeof(BATTERY_PROFILE_STRUC);
			break;
		default:	// 2 : Guangyu + Guangyu
...
int fgauge_get_saddles_r_table(void)
{
		...
		{
			case 1: 	// 1 : Sunwoda + Samsung
				return sizeof(r1_profile_t2) / sizeof(R_PROFILE_STRUC);
				break;
			case 7: 	// 7 :	Feimaotui + Samsung(MI2A)
				return sizeof(r7_profile_t2) / sizeof(R_PROFILE_STRUC);
				break;
			default:	// 2 : Guangyu + Guangyu
...
BATTERY_PROFILE_STRUC_P fgauge_get_profile(kal_uint32 temperature)
{
		...
		switch(bat_module_id)
		{
			case 1: 			// 1 : Sunwoda + Samsung
				...
				{
					case TEMPERATURE_T0:
						return &battery1_profile_t0[0];
						break;	  
					case TEMPERATURE_T1:
						return &battery1_profile_t1[0];
						break;
					case TEMPERATURE_T2:
						return &battery1_profile_t2[0];
						break;
					case TEMPERATURE_T3:
						return &battery1_profile_t3[0];
						break;
					case TEMPERATURE_T:
						return &battery1_profile_temperature[0];
						break;
					default:
						return NULL;
						break;
			...
			case 7: 	// 7 :	Feimaotui + Samsung(MI2A)
				...
				{
					case TEMPERATURE_T0:
						return &battery7_profile_t0[0];
						break;	  
					case TEMPERATURE_T1:
						return &battery7_profile_t1[0];
						break;
					case TEMPERATURE_T2:
						return &battery7_profile_t2[0];
						break;
					case TEMPERATURE_T3:
						return &battery7_profile_t3[0];
						break;
					case TEMPERATURE_T:
						return &battery7_profile_temperature[0];
						break;
					default:
						return NULL;
						break;
...
R_PROFILE_STRUC_P fgauge_get_profile_r_table(kal_uint32 temperature)
{
		...
		switch (bat_module_id)
		{
			case 1: 			// 1 : Sunwoda + Samsung
				...
				{
					case TEMPERATURE_T0:
						return &r1_profile_t0[0];
						break;
					case TEMPERATURE_T1:
						return &r1_profile_t1[0];
						break;
					case TEMPERATURE_T2:
						return &r1_profile_t2[0];
						break;
					case TEMPERATURE_T3:
						return &r1_profile_t3[0];
						break;
					case TEMPERATURE_T:
						return &r1_profile_temperature[0];
						break;
					default:
						return NULL;
						break;
			...
			case 7: 	// 7 :	Feimaotui + Samsung(MI2A)
				...
				{
					case TEMPERATURE_T0:
						return &r7_profile_t0[0];
						break;
					case TEMPERATURE_T1:
						return &r7_profile_t1[0];
						break;
					case TEMPERATURE_T2:
						return &r7_profile_t2[0];
						break;
					case TEMPERATURE_T3:
						return &r7_profile_t3[0];
						break;
					case TEMPERATURE_T:
						return &r7_profile_temperature[0];
						break;
					default:
						return NULL;
						break;
...
void dod_init(void)
{
	...
	dod_init_g_rtc_fg_soc_bk = g_rtc_fg_soc; 
    #endif
	...
	dod_init_gFG_capacity_by_v_bk=gFG_capacity_by_v; 
...
void oam_init(void)
{
    ...
    oam_init_gFG_voltage_bk = gFG_voltage; 
    oam_init_vol_bat_bk = vol_bat;

	 if((bat_is_charger_exist() == KAL_TRUE)||(get_rtc_spare_fg_value()!=0)) 
	 {
	 	bm_print(BM_LOG_CRTI,"~~Set oam_init compare !!! "); 
if(abs(UbVbat-gFG_voltage)>30) 
{ 
bm_print(BM_LOG_CRTI,"~~Set hw_ocv(%d) to UbVbat(%d) \n ",gFG_voltage,UbVbat); 
gFG_voltage = UbVbat; 
} 
if(abs(UbVbat-vol_bat)>30) 
{ 
bm_print(BM_LOG_CRTI,"~~Set vbat(%d) to UbVbat(%d) \n ",vol_bat,UbVbat); 
vol_bat = UbVbat; 
		}
} 

	gFG_capacity_by_v = fgauge_read_capacity_by_v(gFG_voltage);
	oam_init_gFG_capacity_by_v_bk = gFG_capacity_by_v;
	vbat_capacity = fgauge_read_capacity_by_v(vol_bat);
	oam_init_vbat_capacity_bk = vbat_capacity;
...
void oam_run(void)
{
	...
	bm_print(BM_LOG_CRTI,"~~UbVbat: %d,oam_init_gFG_voltage_bk : %d,oam_init_vol_bat_bk : %d,oam_init_gFG_capacity_by_v_bk : %d,oam_init_vbat_capacity_bk is %d ,dod_init_g_rtc_fg_soc_bk :%d,dod_init_gFG_capacity_by_v_bk :%d\n ",UbVbat,oam_init_gFG_voltage_bk,oam_init_vol_bat_bk,oam_init_gFG_capacity_by_v_bk,oam_init_vbat_capacity_bk,dod_init_g_rtc_fg_soc_bk,dod_init_gFG_capacity_by_v_bk);//======= add ==========	
	bm_print(BM_LOG_CRTI, "g_boot_reason = %d,g_boot_mode = %d\r\n", g_boot_reason, g_boot_mode);
}

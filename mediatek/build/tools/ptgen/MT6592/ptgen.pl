...
sub InitGlobalValue
{
	...
	my $PROJECT_PART_TABLE_FILENAME        = "mediatek/config/$ENV{PROJECT}/partition_table_$ArgList{PLATFORM}.xls"; 
	my $FULL_PROJECT_PART_TABLE_FILENAME   = "mediatek/config/$ENV{FULL_PROJECT}/partition_table_$ArgList{PLATFORM}.xls"; 
    if ($ArgList{PL_MODE})
    {
    ...
    {
		if (-e $FULL_PROJECT_PART_TABLE_FILENAME )
		{
			$Partition_layout_xls = "mediatek/config/$ENV{FULL_PROJECT}/partition_table_$ArgList{PLATFORM}.xls";
		}
		elsif (-e $PROJECT_PART_TABLE_FILENAME )
		{
			$Partition_layout_xls = "mediatek/config/$ENV{PROJECT}/partition_table_$ArgList{PLATFORM}.xls";
		}
    	else
    	{

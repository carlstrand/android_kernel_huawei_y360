...
my $CUSTOM_MEMORYDEVICE_H_NAME  = "mediatek/custom/$PROJECT/preloader/inc/custom_MemoryDevice.h";
	my $WT_REGION_TABLE_FILENAME = "mediatek/config/${PROJECT}/MemoryDeviceList_${PLATFORM}.xls";
	my $WT_PROJECT_PART_TABLE_FILENAME = "mediatek/config/$PROJECT/partition_table_${PLATFORM}.xls"; 
		if (-e $WT_REGION_TABLE_FILENAME )
		{
			$REGION_TABLE_FILENAME = $WT_REGION_TABLE_FILENAME;
		}
		if (-e $WT_PROJECT_PART_TABLE_FILENAME )
		{
			$PART_TABLE_FILENAME = $WT_PROJECT_PART_TABLE_FILENAME ;
		}

...
#define NS_TO_CYCLE(n, c)	((n) / (c))
   ...
   hs_trail_m=1;
   if((lcm_params->dsi.HS_TRAIL & 0xF0) == 0x50)
   {
        lcm_params->dsi.HS_TRAIL &= 0x0F;
   ...
   if((lcm_params->dsi.CLK_TRAIL & 0xF0) == 0x50)
   {
        lcm_params->dsi.CLK_TRAIL &= 0x0F;
		timcon2.CLK_TRAIL	= ((lcm_params->dsi.CLK_TRAIL == 0) ? NS_TO_CYCLE(0x64, cycle_time) : lcm_params->dsi.CLK_TRAIL) + 0x05;
   }
	else
	{
